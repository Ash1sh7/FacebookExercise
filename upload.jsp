...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-90GP33FENS"></script>
	<script>
	  window.dataLayer = window.dataLayer || [];
	  function gtag(){dataLayer.push(arguments);}
	  gtag('js', new Date());
	
	  gtag('config', 'G-90GP33FENS');
	</script>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<div id="portfolio" class="container-fluid text-center bg-grey">
	<h1>Dominant colors of the Image</h1><br>
	<div class="row text-center " float="left" width=60%>
		<div class="col-sm-12">
			<div class="img-container">
				<img src="<%=request.getAttribute("imageUrl")%>" height=250px width=250px>
				<% if(((String)request.getAttribute("dominantColor")).equalsIgnoreCase("red")) { %>
					<img src="https://storage.googleapis.com/images123442/red.jpg"  height=250px width=250px>
				<% } else if(((String)request.getAttribute("dominantColor")).equalsIgnoreCase("green")) { %>
					<img src="https://storage.googleapis.com/images123442/green.jpg"  height=250px width=250px>
				<% } else if(((String)request.getAttribute("dominantColor")).equalsIgnoreCase("blue")) { %>
					<img src="https://storage.googleapis.com/images123442/blue.jpg"  height=250px width=250px>
				<% } else {%>
					<p><%=((String)request.getAttribute("dominantColor"))%></p>
				<% } %>
	...
	<div id="alert" style="display:none" class ="alert alert-success"> <strong > Success!!!!</strong> Share on Facebook.
	</div>
</div><br>
</div>
